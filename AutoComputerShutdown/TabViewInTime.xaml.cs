...
{
    /// <summary>
    /// Interaction logic for TabViewInTime.xaml
    /// </summary>
    public partial class TabViewInTime : UserControl
    {
        ...
        public TabViewInTime()
        {
            InitializeComponent();

            timeSpinner = new TimeSpinner(false, ItemsControl);
        ...
        private void StartAction(object sender, RoutedEventArgs e)
        {
            ...
            TimeSpan timespanDifference = new TimeSpan(timeSpinner.Hours, timeSpinner.Minutes, timeSpinner.Seconds);
        ...
        private void LogoutAction(object sender, EventArgs e)
        {
            ...
            if (secondsTimespan.TotalSeconds == 120)
            {
                SendNotification("Log out in 2 minutes!", $"You will be logged out in 2 minutes!");
            }
        ...
        private void RestartAction(object sender, EventArgs e)
        {
            ...
            if (secondsTimespan.TotalSeconds == 120)
            {
                SendNotification("Restart in 2 minutes!", $"The computer will be restarted in 2 minutes!");
            }
        ...
        private void ShutdownAction(object sender, EventArgs e)
        {
            ...
            if (secondsTimespan.TotalSeconds == 120)
            {
                SendNotification("Shutdown in 2 minutes!", $"The computer will be shut down in 2 minutes!");
            }
            if (secondsTimespan.TotalSeconds == 0)
            {
